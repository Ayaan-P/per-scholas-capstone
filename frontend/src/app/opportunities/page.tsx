                ...
                <div className="space-y-4">
                  ...
                  <div className="border-t pt-4">
                    <button
                      ...
                      className="w-full flex items-center justify-between px-4 py-2.5 bg-gradient-to-r from-perscholas-secondary/10 to-blue-50 text-perscholas-secondary rounded-lg text-sm font-semibold hover:from-perscholas-secondary/20 hover:to-blue-100 active:scale-95 transition-all"
                    >
                    ...
                    {showSettings && (
                      <div className="mt-4 space-y-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                        <div>
                          <label className="text-xs font-semibold text-gray-700 mb-2 block">Scheduler Frequency</label>
                          <select
                          ...
                          <p className="text-xs text-gray-600 mt-1.5">How often searches run for new opportunities</p>
                        </div>

                        <div>
                          <label className="text-xs font-semibold text-gray-700 mb-2 block">Target States</label>
                          <div className="flex gap-2 mb-2">
                            <input
                              ...
                              maxLength={2}
                              className="flex-1 px-3 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-perscholas-secondary/20 focus:border-perscholas-secondary"
                            />
                            <button
                              onClick={() => {
                                if (stateInput) {
                              ...
                              className="px-3 py-2.5 bg-perscholas-secondary text-white rounded-lg text-sm font-medium hover:bg-perscholas-dark transition-colors"
                            >
                              Add
                            </button>
                          </div>
                          <div className="flex flex-wrap gap-2">
                            {selectedStates.map((state) => (
                              <span
                                key={state}
                                className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-perscholas-secondary text-white rounded-full text-xs font-medium"
                              >
                                {state}
                                <button
                        ...
                        <div>
                          <label className="text-xs font-semibold text-gray-700 mb-2 block">Target Cities</label>
                          <div className="flex gap-2 mb-2">
                            <input
                              type="text"
                              value={cityInput}
                          ...
                          <div className="flex flex-wrap gap-2">
                            {selectedCities.map((city) => (
                              <span
                                key={city}
                                className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-gray-200 text-gray-700 rounded-full text-xs font-medium"
                              >
                                {city}
                                <button
